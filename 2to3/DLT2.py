...
import numpy as N
from calculate_3d import single_traj_process_2view
...
def test():
    ...
    traj1, traj2 = single_traj_process_2view(traj_dir_2view_1,traj_dir_2view_2)
    xyz1234 = N.zeros((len(traj1),3))
    for i in range(len(traj1)):
        xyz1234[i,:] = DLTrecon( nd, nc, L1234, [traj1[i],traj2[i]] )
